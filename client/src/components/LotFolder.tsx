            ...
            <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  {new Date(lot.info.createdAt).toLocaleDateString("pt-BR", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                    hour: "2-digit",
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  {new Date(lot.info.updatedAt).toLocaleDateString("pt-BR", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                    hour: "2-digit",
              ...
              <div className="bg-gray-50 p-4 rounded-lg min-h-48 text-gray-700 whitespace-pre-wrap">
                {notes || (
                  <span className="text-gray-400 italic">
                    Nenhuma nota adicionada. Clique em "Editar" para adicionar.
                  </span>
                )}
              </div>
            )}
